const Coverpic = () => {
  return (
    <section className="coverpic flex items-center relative">
      <div className="picture bg-neutral-600 absolute left-11 -z-10 bottom-2">
        {" "}
      </div>
      <img
        ...
        alt=""
        className=" border-8 border-white picture "
      />
    </section>
  );
};
