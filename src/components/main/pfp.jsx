const Pfp = () => {
  return (
    <section className=" w-[568px] h-[364px] relative flex items-center">
      <div className="w-72 h-80  bg-gray-800 absolute left-10 -z-10 top-14"></div>
      <img
        ...
        alt=""
        className="w-72 h-80 border-8 border-black absolute "
      />
    </section>
  );
};
