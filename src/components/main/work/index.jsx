const Work = ({ project, desc, projectName, swap }) => {
  return (
    <section
      className={`m-auto flex ${
        swap ? "flex-row-reverse" : ""
      } items-center gap-10 work dark:bg-gray-800 px-5 rounded-lg max-sm:w-[340px] max-sm:h-[780px] max-sm:flex-col max-sm:py-10`}
    >
